...
import { getCategoryLabel, getCategoryIcon, getCategoryColor } from '@/lib/utils/categories'
 ...
 */
export default async function CategoryInCityPage({ params, searchParams }: CategoryInCityPageProps) {
    ...
    <>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          Find verified {categoryLabel.toLowerCase()} resources in {city}, {state}. All listings are
      ...
      {pageData.topRatedResourceId && (
        <Card sx={{ mb: 4, bgcolor: 'success.light', borderLeft: 4, borderColor: 'success.main' }}>
          <Box sx={{ p: 2 }}>
          ...
          {!hasResults && (
            <Alert severity="info" sx={{ mb: 3 }}>
              ...
              <Typography variant="body2">
                ...
                <Link href={`/${cityStateSlug}`}>browsing all categories</Link> or check back soon.
              </Typography>
            </Alert>
          )}
