...
/**
 * Tag-specific Resources Page
 * SEO-friendly route: /resources/tag/{tag}
 */
      ...
      <Box sx={{ mb: 4 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2 }}>
          <Chip
            ...
            label={displayTag}
            color="primary"
            sx={{ fontSize: '1.25rem', height: 48, px: 2 }}
          />
          <Typography variant="h3" component="h1">
            Resources{isSearching && <> - &ldquo;{search}&rdquo;</>}
          </Typography>
        </Box>
        ...
        <Grid size={{ xs: 12, md: 9 }}>
          ...
          {!hasResults && (
            <Alert
              ...
              sx={{ mb: 3 }}
              action={
                <Link href={`/resources/tag/${tag}`} style={{ textDecoration: 'none' }}>
