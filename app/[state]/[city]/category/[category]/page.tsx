...
import { getCategoryInCityPageData } from '@/lib/api/seo-pages'
 ...
 * URL: /ca/oakland/employment, /ca/san-francisco/housing, etc.
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        {pageData.topRatedResourceId && (
          ...
          >
            <Box sx={{ p: 2 }}>
              ...
              <Link
                href={getResourceUrl({ id: pageData.topRatedResourceId })}
            ...
            {!hasResults && (
              <Alert severity="info" sx={{ mb: 3 }}>
                ...
                <Typography variant="body2">
                  ...
                  <Link href={cityUrl}>browsing all categories</Link> or check back soon.
                </Typography>
              </Alert>
            )}
        ...
        <Box sx={{ mt: 6, pt: 4, borderTop: 1, borderColor: 'divider' }}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
            <Link href={cityUrl}>View all categories</Link> or browse related resources:
          </Typography>
