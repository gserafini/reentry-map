...
/**
 * City Hub Page
 * URL: /ca/oakland, /ca/san-francisco, etc.
            ...
            <Grid size={{ xs: 12, sm: 6 }}>
              <Card>
                <CardContent>
                  ...
                  <Link
                    href={getResourceUrl({ id: cityData.topRatedResourceId })}
            ...
            <Grid size={{ xs: 12, sm: 6 }}>
              <Card>
                <CardContent>
                  ...
                  <Link
                    href={getResourceUrl({ id: cityData.newestResourceId })}
                    style={{ textDecoration: 'none', color: 'inherit' }}
                  >
                    <Typography
                      variant="body1"
            ...
            {Object.entries(cityData.categoryCounts)
              ...
              .map(([category, count]) => {
                ...
                return (
                  <Link
                    key={category}
                    href={generateCategoryInCityUrl(city, state, category as ResourceCategory)}
